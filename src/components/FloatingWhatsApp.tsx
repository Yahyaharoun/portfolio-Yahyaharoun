...
export function FloatingWhatsApp() {
  const whatsappNumber = "2250787265147"; // Using the number from Footer
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 sm:right-10 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-2xl hover:shadow-[#25D366]/30 transition-all duration-300"
